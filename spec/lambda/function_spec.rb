  ...
  describe '#create' do
    context "Resource DOES NOT exist" do
      it "Create the resource" do
        expect { Resource::Lambda::Function.new(config).create }.not_to raise_error
  ...
  describe "#modify" do
    context "All keys are present and the function DOES exist" do
      it "changes the function configuration to match desired properties" do
        expect { Resource::Lambda::Function.new(config).create }.not_to raise_error
        expect { Resource::Lambda::Function.new(config2).modify }.not_to raise_error
    ...
    context "All keys are present and the function DOES exist" do
      it "changes the function code to match desired properties" do
        ...
        expect { Resource::Lambda::Function.new(config_code_update).modify }.not_to raise_error
